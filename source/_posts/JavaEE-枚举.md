...
>  本文转载自：https://dunwu.github.io/javacore/basics/java-enum.html
>
> 更多信息参见原博客

- [1. 简介](https://dunwu.github.io/javacore/basics/java-enum.html#1-简介)
- [2. 枚举的本质](https://dunwu.github.io/javacore/basics/java-enum.html#2-枚举的本质)
- [3. 枚举的方法](https://dunwu.github.io/javacore/basics/java-enum.html#3-枚举的方法)
- \4. 枚举的特性
  - [4.1. 基本特性](https://dunwu.github.io/javacore/basics/java-enum.html#41-基本特性)
  - [4.2. 枚举可以添加方法](https://dunwu.github.io/javacore/basics/java-enum.html#42-枚举可以添加方法)
  - [4.3. 枚举可以实现接口](https://dunwu.github.io/javacore/basics/java-enum.html#43-枚举可以实现接口)
  - [4.4. 枚举不可以继承](https://dunwu.github.io/javacore/basics/java-enum.html#44-枚举不可以继承)
- \5. 枚举的应用
  - [5.1. 组织常量](https://dunwu.github.io/javacore/basics/java-enum.html#51-组织常量)
  - [5.2. switch 状态机](https://dunwu.github.io/javacore/basics/java-enum.html#52-switch-状态机)
  - [5.3. 错误码](https://dunwu.github.io/javacore/basics/java-enum.html#53-错误码)
  - [5.4. 组织枚举](https://dunwu.github.io/javacore/basics/java-enum.html#54-组织枚举)
  - [5.5. 策略枚举](https://dunwu.github.io/javacore/basics/java-enum.html#55-策略枚举)
  - [5.6. 枚举实现单例模式](https://dunwu.github.io/javacore/basics/java-enum.html#56-枚举实现单例模式)
- \6. 枚举工具类
  - [6.1. EnumSet](https://dunwu.github.io/javacore/basics/java-enum.html#61-enumset)
  - [6.2. EnumMap](https://dunwu.github.io/javacore/basics/java-enum.html#62-enummap)
- [7. 小结](https://dunwu.github.io/javacore/basics/java-enum.html#7-小结)
- [8. 参考资料](https://dunwu.github.io/javacore/basics/java-enum.html#8-参考资料)

## [#](https://dunwu.github.io/javacore/basics/java-enum.html#_1-简介)1. 简介
...
## [#](https://dunwu.github.io/javacore/basics/java-enum.html#_2-枚举的本质)2. 枚举的本质
...
## [#](https://dunwu.github.io/javacore/basics/java-enum.html#_3-枚举的方法)3. 枚举的方法
...
## [#](https://dunwu.github.io/javacore/basics/java-enum.html#_4-枚举的特性)4. 枚举的特性
...
### [#](https://dunwu.github.io/javacore/basics/java-enum.html#_4-1-基本特性)4.1. 基本特性

**如果枚举中没有定义方法，也可以在最后一个实例后面加逗号、分号或什么都不加。**

如果枚举中没有定义方法，**枚举值默认为从 0 开始的有序数值**。以 Color 枚举类型举例，它的枚举常量依次为 `RED：0，GREEN：1，BLUE：2`。

### [#](https://dunwu.github.io/javacore/basics/java-enum.html#_4-2-枚举可以添加方法)4.2. 枚举可以添加方法
...
注：上面的例子并不可取，仅仅是为了展示枚举支持定义各种方法。正确的例子情况[错误码示例](https://dunwu.github.io/javacore/basics/java-enum.html#错误码)

### [#](https://dunwu.github.io/javacore/basics/java-enum.html#_4-3-枚举可以实现接口)4.3. 枚举可以实现接口
...
### [#](https://dunwu.github.io/javacore/basics/java-enum.html#_4-4-枚举不可以继承)4.4. 枚举不可以继承

**enum 不可以继承另外一个类，当然，也不能继承另一个 enum 。**

因为 `enum` 实际上都继承自 `java.lang.Enum` 类，而 Java 不支持多重继承，所以 `enum` 不能再继承其他类，当然也不能继承另一个 `enum`。

## [#](https://dunwu.github.io/javacore/basics/java-enum.html#_5-枚举的应用)5. 枚举的应用

### [#](https://dunwu.github.io/javacore/basics/java-enum.html#_5-1-组织常量)5.1. 组织常量
...
### [#](https://dunwu.github.io/javacore/basics/java-enum.html#_5-2-switch-状态机)5.2. switch 状态机
...
### [#](https://dunwu.github.io/javacore/basics/java-enum.html#_5-3-错误码)5.3. 错误码
...
### [#](https://dunwu.github.io/javacore/basics/java-enum.html#_5-4-组织枚举)5.4. 组织枚举
...
### [#](https://dunwu.github.io/javacore/basics/java-enum.html#_5-5-策略枚举)5.5. 策略枚举
...
### [#](https://dunwu.github.io/javacore/basics/java-enum.html#_5-6-枚举实现单例模式)5.6. 枚举实现单例模式
...
> 扩展阅读：[深入理解 Java 枚举类型(enum)(opens new window)](https://blog.csdn.net/javazejian/article/details/71333103#enumset实现原理剖析)
>
> 这篇文章对于 Java 枚举的特性讲解很仔细，其中对于枚举实现单例和传统单例实现方式说的尤为细致。

## [#](https://dunwu.github.io/javacore/basics/java-enum.html#_6-枚举工具类)6. 枚举工具类

Java 中提供了两个方便操作 enum 的工具类——`EnumSet` 和 `EnumMap`。

### [#](https://dunwu.github.io/javacore/basics/java-enum.html#_6-1-enumset)6.1. EnumSet
...
### [#](https://dunwu.github.io/javacore/basics/java-enum.html#_6-2-enummap)6.2. EnumMap
